...
import AdrStats, { AdrStatsProps } from '@lullabot/gatsby-theme-adr/src/components/AdrStats';
...
const HomePage = (props: PropsWithChildren<PageProps>) => {
  ...
  return (
    <Layout {...props}>
      <PageTitle
        deck="Welcome to the architecture knowledge base of University of Cambridge, University Information Services. You will find here all the Architecture Decision Records (ADR) of the project."
        preTitle="ADR"
      >
        University of Cambridge, University Information Services&apos; Architecture Decision Records
      </PageTitle>
      <section
      ...
      >
        ...
        <p>
          ...
          <code>main</code> branch of the project’s Git repository. In fact,
          the developers manage this documentation directly with markdown files
